 ...
 */
contract ERC20Freigeld is Context, IERC20, IERC20Metadata {
  ...
  uint256 private _rate_denominator = 0;
  uint256 private _rate_numerator = 0;
  uint256 private _interests = 0;
  ...
  /**
   * @dev Returns the amount of interests deducted from the totalSupply.
   */
  ...
  /**
   * @dev Sets the interest rate per block with a combination of
  ...
  function _setRate (uint256 _numerator, uint256 _denominator) internal virtual {
    ...
    _rate_numerator = _numerator;
    _rate_denominator = _denominator;
  }
